...
public:
     ...
     */
    void SetConfigReceiver(const ConfigKey& key, const std::shared_ptr<IPendingIntentRef>& pir);

    /**
     * Returns the package name and class name representing the broadcast receiver for this config.
     */
    const std::shared_ptr<IPendingIntentRef> GetConfigReceiver(const ConfigKey& key) const;
     ...
     * receiver.
     */
    void RemoveConfigReceiver(const ConfigKey& key, const std::shared_ptr<IPendingIntentRef>& pir);

    /**
     * Sets the broadcast receiver that is notified whenever the list of active configs
     * changes for this uid.
     */
    void SetActiveConfigsChangedReceiver(const int uid,
    ...
    const std::shared_ptr<IPendingIntentRef> GetActiveConfigsChangedReceiver(const int uid) const;
...
private:
     ...
     */
    std::map<ConfigKey, std::shared_ptr<IPendingIntentRef>> mConfigReceivers;
     ...
     */
    std::map<int, std::shared_ptr<IPendingIntentRef>> mActiveConfigsChangedReceivers;
     ...
     */
    std::map<ConfigKeyWithPackage, std::map<int32_t, std::shared_ptr<IPendingIntentRef>>>
